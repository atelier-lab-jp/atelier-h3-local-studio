...
- **現在フェーズ**: **P5 完了。V1.0.0 Release Candidate（実iPhoneでの最終確認待ち）**
...
- **992 passed + 1 xpassed**（P4 時点は 625+1。P5 で 367 件追加）
...
3. `.venv/bin/python -m pytest tests/ -q` が **992 passed + 1 xpassed** であること
